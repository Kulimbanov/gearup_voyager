...
<div class="container p-4">
    ...
    <section class="mb-4">
        ...
        <a class="social btn btn-floating m-1" href="{{setting('site.facebook')}}" role="button">
        ...
        <a class="social btn btn-floating m-1" href="{{setting('site.instagram')}}" role="button">
        ...
        <a class="social btn btn-floating m-1" href="{{setting('site.youtube')}}" role="button">
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-youtube"
                 viewBox="0 0 16 16">
                <path class="icon--youtube"
    ...
    <section class="row mb-4">
        <a class="col-1 m-auto" href="{{ url('/') }}">
            <img class="w-100" src="{{Voyager::image(setting('site.logo_footer'))}}">
        </a>
